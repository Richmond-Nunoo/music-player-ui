  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      centerTitle: true,
        ...
        actions: const [Icon(Icons.more_vert_outlined, color: Colors.black, size: 25,),
      ],
      ),
      ...
      ListView(
        children: [
            Container( margin: const EdgeInsets.only(top: 50, left: 60, right: 60, bottom: 20),
            height: 300.0, width: 0,
          ...
          Column(
            children:[
               Padding(
                 ...
                 child: Text(widget.playlist.arSongTitle, 
              ...
              (fontWeight: FontWeight.bold,
               ...
               Padding(
                 ...
                 child: Text(widget.playlist.artName,
                  style: const TextStyle(
                  color: Colors.grey,
                  fontWeight: FontWeight.bold, fontSize: 15,),),
               ),
...
// width: MediaQuery.of(context).size.width,
// child:
// const Slider( value: 50, min: 0, max:100, onChanged: null))])